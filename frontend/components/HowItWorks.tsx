          ...
          {steps.map((step, idx) => (
            ...
            >
              <div className="flex flex-col items-center text-center">
                <div className="w-24 h-24 rounded-full glass-panel flex items-center justify-center mb-8 border border-white/10 relative">
                  ...
                  {/* Step ID badge */}
                  <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-primary flex items-center justify-center text-sm font-bold shadow-lg border border-white/20">
                    {step.id}
                  </div>
                </div>
